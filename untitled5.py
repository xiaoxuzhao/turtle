...
obsData=pd.read_csv(turtle_input_data_file,index_col=0) #this inputfile was created by tdWithModTempByDepth_roms.py
...
shipData=pd.read_csv(ship_input_data_file,index_col=0)
