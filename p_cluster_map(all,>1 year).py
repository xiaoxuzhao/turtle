# -*- coding: utf-8 -*-
"""
Created on Wed Mar  7 12:03:39 2018
...
#####################
df_fsrs=read_csv(input_dir+'p_cluster_sites(>1 km,year).csv')  #p_cluster_sites(>1 km,year).py
df_getfsrs=read_csv(input_dir+'p_cluster_stations_60.0_bins(fsrs).csv')          #p_cluster_stations_xiaoxu.py
...
my_map.drawmeridians(np.arange(-180,180,3),labels=[1,1,0,1])
plt.savefig(save_dir+'compare_p_cluster_map(all sites,>1 year)',dpi=200) 
plt.show()
"""
