...
num_of_dist_range=1 # this is the # of various distances we are testing (to test program initially, set to "1')
...
if mode=='whole_profile':
    for d in range(len(day)): # 4 kind of days 
     ...
     rms_r=[]
     for s in range(num_of_dist_range): #each day includes 15 different range of distance
