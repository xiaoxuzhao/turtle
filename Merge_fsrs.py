...
df_sites=read_csv('fsrs_sites.csv')
df_fsrs=read_csv('getfsrs.csv')
df_scalar=read_csv('CTSscalarstats.csv')
def list_of_groups(init_list, childern_list_len):
    ...
    return end_list
#######################
#get the whole indexs of the fsrs_sites.csv (2127)
...
Event_spec,Latitude,Longitude,Start,Date,num_date,Dep,Min_t,Max_t,Mean_t,Stdev_t,Index_first=[],[],[],[],[],[],[],[],[],[],[],[]
for i in index_site:
...
frame.to_csv("merge_date_end.csv")