...
t_ids=[118905,151558,149443,161445,151561,159796,151560,161868,159797,161444,161300,161292,161442,161294,161441]
...
fig.text(0.5, 0.04, 'Time(2017)', ha='center', va='center', fontsize=14)#  0.5 ,0.04 represent the  plotting scale of x_axis and y_axis
