...
turtle_input_data_file='../turtle/ctdWithModTempByDepth.csv'
ship_input_data_file='zb/turtle/changed/ship06-08_MODELtemp.csv'
...
for i in range(1):
    if i==1:
       ...
       ax.text(i, Mean_day[0][i]+0.08, N3_10[i],
           #va='bottom', ha='right',
